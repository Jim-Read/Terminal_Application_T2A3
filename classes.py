...
def progress_bar_decorator(func):
    def inner(*args, **kwargs):
        for i in range(1, 500):
            sg.one_line_progress_meter('API calls', i+1, 500, 'key','Retrieving Information ... ', (50,50), orientation='h')
...
class Iss:
    ...
    def get_timezone_location(parameters):
        ...
        response = (requests.get(url)).json()  ## Make a request and convert from json to dictionary
...
class Gui:
    ...
    def make_gui():
        ...
        while True:
            ...
            if event == "Help":
                with open('../tttttttttttttttttttttt/help.txt', 'r') as file:
                    help_file = file.read()
...
class Menu:
    ...
    def help_text():
        cls()
        with open('../tttttttttttttttttttttt/help_file_gui.txt', 'r') as help_file:
